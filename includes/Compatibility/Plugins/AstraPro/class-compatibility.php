...
namespace RSFA\Compatibility\Plugins\AstraPro;
...
class Compatibility extends Base_Compatibility {
	...
	public function woo_single_product_layouts() {
		...
		if ( ( class_exists( 'Woocommerce' ) && is_product() ) && ( false === $astra_ext_instance::$wc_layout_built_with_themer ) && apply_filters( 'rsfa_astra_addon_override_single_product_layout', true ) ) {
