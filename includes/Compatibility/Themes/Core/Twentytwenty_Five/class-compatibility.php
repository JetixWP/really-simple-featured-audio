...
namespace RSFA\Compatibility\Themes\Core\Twentytwenty_Five;
...
class Compatibility extends Base_Compatibility {
	...
	public function enqueue_scripts() {
		// Register styles.
		wp_register_style( 'rsfa-twentytwentyfive', $this->get_current_dir_url() . 'Core/Twentytwenty_Five/styles.css', array(), filemtime( $this->get_current_dir() . 'Core/Twentytwenty_Five/styles.css' ) );

		// Enqueue styles.
		wp_enqueue_style( 'rsfa-twentytwentyfive' );

		// Add generated CSS.
		wp_add_inline_style( 'rsfa-twentytwentyfive', Plugin::get_instance()->frontend_provider->generate_dynamic_css() );
	}
