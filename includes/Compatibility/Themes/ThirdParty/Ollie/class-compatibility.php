...
namespace RSFA\Compatibility\Themes\ThirdParty\Ollie;
...
class Compatibility extends Base_Compatibility {
	...
	public function enqueue_scripts() {
		// Register styles.
		wp_register_style( 'rsfa-ollie', $this->get_current_dir_url() . 'ThirdParty/Ollie/styles.css', array(), filemtime( $this->get_current_dir() . 'ThirdParty/Ollie/styles.css' ) );

		// Enqueue styles.
		wp_enqueue_style( 'rsfa-ollie' );

		// Add generated CSS.
		wp_add_inline_style( 'rsfa-ollie', Plugin::get_instance()->frontend_provider->generate_dynamic_css() );
	}
